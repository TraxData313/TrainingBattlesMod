...
namespace TrainingBattles.Mcm
{
    ...
    /// earns the XP, the surgeon answers for the fallen, the scout wins the ground. The engineer
    /// gets a group of their own when the castle drills land.
    /// </summary>
    public sealed class TrainingBattlesMcmSettings : AttributeGlobalSettings<TrainingBattlesMcmSettings>
    {
        ...
        [SettingPropertyGroup("Pacing & costs", GroupOrder = 4)]
        ...
        [SettingPropertyBool("Deal the company in half by default", Order = 3, RequireRestart = false,
        ...
        [SettingPropertyBool("Disorganized after training", Order = 4, RequireRestart = false,
        ...
        [SettingPropertyGroup("Controls", GroupOrder = 6)]
        ...
        [SettingPropertyGroup("Debug", GroupOrder = 7)]
